...
<ROUTINE STORY005-PRECHOICE ()
	<COND (<IN? ,SKILL-CHARMS ,SKILLS>
		<COND (<IN? ,FEATHER-SHIELD ,PLAYER>
			<LOSE-LIFE 2 "You have died from the Ejada's sorcery." ,STORY005>
		)(ELSE
			<LOSE-LIFE 4 "You have died from the Ejada's sorcery." ,STORY005>
		)>
	)(ELSE
		<LOSE-LIFE 6 "You have died from the Ejada's sorcery." ,STORY005>
	)>>
